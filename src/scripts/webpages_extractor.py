...
def save_strings_to_md(string, output_dir, tags):
    ...
    filename = os.path.join(output_dir, "test.md")
...
def download_files_from_yaml(yaml_file="../../sources/test_landscape_augmented.yml", output_directory="sources/raw_files"):
    """
    ...
    for category in data['landscape']:
        ...
        for subcategory in category.get('subcategories', []):
            ...
            for item in subcategory.get('items', []):
                ...
                extract_text(
                    website.get('docs', []), output_directory, tags_dict)
